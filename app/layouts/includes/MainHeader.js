        ...
        <>
            <div id="MainHeader" className="border-b">
                <div className="flex items-center justify-between w-full mx-auto max-w-[1200px]">
                    <div className="flex items-center w-full bg-custom-color">
                                ...
                                <div className="relative ">
                                    <div className="flex items-center ">
                                        <div className="relative flex items-center border-2 border-gray-900 w-full p-2 rounded-xl">
                                            ...
                                            : null} 
                                        <button className="flex items-center bg-white text-sm font-semibold text-back-color p-[11px] ml-1 px-14 rounded-xl">
                                            Search
                                        </button>
                                    </div>
                                </div>
